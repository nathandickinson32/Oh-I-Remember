...
import UpdateQuestionCategoriesView from '../views/UpdateQuestionCategoriesView.vue';
/**
...
const routes = [
  ...
  {
    path: "/questions/edit-question-categories/:questionId",
    name: "edit-question-categories",
    component: UpdateQuestionCategoriesView,
    meta: {
      requiresAuth: false
    }
  },
